<?php
	...
	if (!isset($_GET['id']) || empty($_GET['id'])) {
		header('Location:' . URL_ACCUEIL); // redirige si pas d'id
		exit;
	}
						...
						<div class="row">
							<div class="col-12">
								<div class="single-main">
									<!-- News Head -->
									<div class="news-head">
										<img src="<?= IMG_DIR . 'actualites/' . htmlspecialchars($actu['imgMise']) ?>" alt="#">
									</div>
									<!-- News Title -->
									...
									<!-- News Text -->
									<div class="news-text">
										<p><?= htmlspecialchars($actu['paraph1']) ?></p>
										<p><?= htmlspecialchars($actu['paraph2']) ?></p>
										...
										<p><?= htmlspecialchars($actu['paraph3']) ?></p>
										<blockquote class="overlay">
											<p><?= htmlspecialchars($actu['messageFort']) ?></p>					
										</blockquote>
										<p><?= htmlspecialchars($actu['paraph4']) ?></p>
										<p><?= htmlspecialchars($actu['paraph5']) ?></p>
									</div>
